...
namespace SecurityApp.WebApi.Algorithms
{
    public class CustomAuthenticatedEncryptor : IAuthenticatedEncryptor
    {
        ...
        {
            using var decryptor = _symmetricAlgorithm.CreateDecryptor(_symmetricAlgorithm.Key,
        ...
        {
            using var encryptor = _symmetricAlgorithm.CreateEncryptor(_symmetricAlgorithm.Key,
                _symmetricAlgorithm.IV);
